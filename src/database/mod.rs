...
impl DbTxn {
    ...
    pub(crate) fn get_asset_balance(
        ...
        // Validated witness consignments already have receive colorings before
        // their Bitcoin transaction confirms. Those allocations are included
        // below; adding the invoice's requested amount would count them twice.
