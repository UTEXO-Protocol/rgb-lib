...
/// In-memory storage for transfer artifacts on wasm32 (replaces filesystem directories).
...
impl Wallet {
    ...
    async fn _get_consignment_async(
        &self,
        proxy_url: &str,
        recipient_id: String,
    ) -> Result<GetConsignmentResponse, Error> {
    ...
    pub async fn refresh(
        ...
        // skip backup operations on wasm32 (no filesystem)
